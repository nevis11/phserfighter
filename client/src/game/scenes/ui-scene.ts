...
import { ASSET_KEYS, HEART_ANIMATIONS, HEART_TEXTURE_FRAME } from '../shared/assets';
import { DataManager } from '../shared/data-manager';
import { CUSTOM_EVENTS, EventBus, PLAYER_HEALTH_UPDATE_TYPE, PlayerHealthUpdated } from '../EventBus';
import { DEFAULT_UI_TEXT_STYLE } from '../shared/common';
...
export class UiScene extends Phaser.Scene {
  ...
  public create(): void {
    ...
    this.events.once(Phaser.Scenes.Events.SHUTDOWN, () => {
      EventBus.off(CUSTOM_EVENTS.PLAYER_HEALTH_UPDATED, this.updateHealthInHud, this);
      EventBus.off(CUSTOM_EVENTS.SHOW_DIALOG, this.showDialog, this);
    });
  }
  ...
  public showDialog(message: string): void {
    ...
    this.time.delayedCall(3000, () => {
      this.#dialogContainer.visible = false;
      EventBus.emit(CUSTOM_EVENTS.DIALOG_CLOSED);
    });
  }
}
